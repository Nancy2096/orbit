...
function ClientCommissionsLayoutContent({ children }: { children: React.ReactNode }) {
  return (
    <div className="p-6">
      <AgencySelector />
      {children}
...
export default function ClientCommissionsLayout({
  children,
}: {
  ...
  return (
    <AgencyProvider>
      <ClientCommissionsLayoutContent>{children}</ClientCommissionsLayoutContent>
    </AgencyProvider>
  )
}

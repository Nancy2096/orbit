...
export default function RssTaskDetailPage() {
  ...
  const deleteTask = () => {
    router.push(`/dashboard/tasksflow/projects/${projectId}`)
  }
...
<div className="flex items-center gap-4">
  ...
  <span>/</span>
  <Link href={`/dashboard/tasksflow/projects/${projectId}`} className="hover:underline">{task.projectName}</Link>
  <span>/</span>
  <Link href={`/dashboard/tasksflow/projects/${projectId}?tab=rss`} className="hover:underline">Parrilla RSS</Link>
  <span>/</span>
              <span>Tarea</span>
            </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <div className="flex items-center gap-3">
          <Button asChild className="bg-orange-500 hover:bg-orange-600 text-white">
            <Link href={`/dashboard/tasksflow/projects/${projectId}?tab=rss`}>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <Link href={`/dashboard/tasksflow/projects/${projectId}`} className="font-medium text-primary hover:underline truncate max-w-[150px]">
                      {task.projectName}
                    </Link>
                  </div>
                  <div className="flex justify-between">

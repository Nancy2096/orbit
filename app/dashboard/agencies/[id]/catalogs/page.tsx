    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Administra las industrias y fuentes de referencia</p>
        </div>
      </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Define las industrias disponibles para clasificar clientes
                </CardDescription>
              </div>
              <Dialog open={industryDialogOpen} onOpenChange={setIndustryDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      {editingIndustry ? "Modifica los datos de la industria" : "Agrega una nueva industria al catálogo"}
                    </DialogDescription>
                  </DialogHeader>
                  <FieldGroup>
                    <Field>
            ...
            <CardContent>
              {industries.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  No hay industrias definidas. Agrega una para comenzar.
                </div>
              ) : (
                <Table>
                  <TableHeader>
